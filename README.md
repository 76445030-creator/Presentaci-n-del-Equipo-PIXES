...
<body>
  ...
  <section class="grid">
    ...
    <div class="card">
      ...
      <p>Se encarga de la coordinación del equipo, la planificación de tareas y la comunicación con el cliente.</p>
    </div>
    ...
    <div class="card">
      ...
      <p>Especialista en interfaces visuales y experiencia de usuario, implementa el diseño en código funcional.</p>
    </div>
    ...
    <div class="card">
      ...
      <p>Encargado de crear prototipos, maquetas y experiencias visuales atractivas para el proyecto.</p>
    </div>
    ...
    <div class="card">
      ...
      <p>Responsable de la gestión de la información, seguridad de los datos y arquitectura del sistema.</p>
    </div>
    ...
    <div class="card">
      ...
      <p>Encargado de mantener la comunicación interna y externa, así como de la
